	...
	<div id="header">
        ...
        <div id="header_2">
            <ul>
                ...
                <li><a href="${ pageContext.servletContext.contextPath }/game/gameAll">게임순위</a></li>
                <li><a href="${ pageContext.servletContext.contextPath }/game/game_insert_form">게임추가</a></li>
                <li><a href="${ pageContext.servletContext.contextPath }/game/delete_form">게임삭제</a></li>
                <li><a href="${ pageContext.servletContext.contextPath }/game/update_form">게임변경</a></li>
                <li><a href="${ pageContext.servletContext.contextPath }/bbs/bbsAll?page=1">게시판</a></li>
                <li><a href="${ pageContext.servletContext.contextPath }/weather/weather">날씨예보</a></li>
                <li><a href="${ pageContext.servletContext.contextPath }/chating/main">채팅</a></li>
