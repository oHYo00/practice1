	...
	<div id="header">
        ...
        <div id="header_2">
            ...
            <li><a href="${ pageContext.servletContext.contextPath }">HOME</a></li>
                ...
                <li><a href="${ pageContext.servletContext.contextPath }/bbs/bbs_insert_form">게시판 글쓰기</a></li>
                <li><a href="${ pageContext.servletContext.contextPath }/bbs/bbs_one_form">게시판 검색</a></li>
                <li><a href="${ pageContext.servletContext.contextPath }/bbs/bbs">게임변경</a></li>
