...
<body onload="connect();">
	<br>
	<br>
	<img src="${ pageContext.servletContext.contextPath }/resources/img/해.png" width=100 height=100><img src="${ pageContext.servletContext.contextPath }/resources/img/구름.png" width=400 height=100>
	<div class="alert alert-danger" style="width: 500px;">
		<div  style="text-align:center">날씨</div>
		<br>
		<div >챗 봇>> 1)오늘날씨  	2)내일날씨</div>
		<br>
		<div id="response">
